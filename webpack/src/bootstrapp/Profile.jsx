...
function Profile() {
  ...
  return (
      ...
      <Offline> You are Offline!</Offline>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <Nav.Link href="/cardie"> Bootstrap Cards</Nav.Link>
            <Nav.Link href="/filtering">Filter Data</Nav.Link>
    ...
    <Routes>
      ...
      <Route path="/cardie" element={<BScards></BScards>}></Route>
      <Route path="/filtering" element={<FilterButtons></FilterButtons>}></Route>
      <Route path="/filtering" element={<FilterButtons></FilterButtons>}></Route>
